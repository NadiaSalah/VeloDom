/**
 * Application-owned learning content displayed by the documentation home page.
 * Keeping static copy outside lifecycle code makes the page script show only
 * the behavior that VeloDom needs to run.
 */
...
export const frameworkPrinciples = [
  {
    number: "01",
    title: "Write a visible feature",
    text: "A page or component is a readable folder, or an optional .vd file."
  },
  {
    number: "02",
    title: "Add small directives",
    text: "Use bindings, events, loops, conditionals, and requests where HTML needs behavior."
  },
  {
    number: "03",
    title: "Let the compiler help",
    text: "Templates, expressions, accessibility signals, and runtime manifests are checked before startup."
  }
];
...
export const learningPath = [
  ...
  { level: "Practice", duration: "8 min", title: "Interactive playground", description: "Use reactive state, a component public API, named slots, refs, and local request routes.", href: "/playground" },
