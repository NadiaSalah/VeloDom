...
VeloDom `1.0.0` is published on npm. The package includes a shorter
...
The explicit `create-velodom` command above
...
This additional tarball entry is included in the published `1.0.0` package;
