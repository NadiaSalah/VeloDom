...
This is the editable default starter shipped inside the VeloDom npm package.
Copy this folder into your workspace, run `npm install`, and make your changes
under `src/`. It demonstrates the public npm workflow: application code stays
in the project, while the framework is installed as the public `velodom`
package.
...
The CLI copies these same starter files for a new project, then sets its
package name:
