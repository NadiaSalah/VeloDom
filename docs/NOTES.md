...
- The package tarball includes `velodomProj/` as an editable copy generated by
  the same scaffold during `package:build`. This keeps the downloadable example
  useful without maintaining a second hand-written starter implementation.
