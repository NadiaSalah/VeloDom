...
| Public package | V1 — Implemented | Published `velodom@1.0.1`, exports and consumer checks pass |
| Browser release gate | V1 — Implemented | GitHub Actions Run #27 passed Chromium, Firefox, WebKit, and Mobile WebKit |
| npm publication | V1 — Implemented | `velodom@1.0.1` published with public access and `latest` dist-tag |
...
`velodom@1.0.1` package is published with the `latest` dist-tag. Future work
