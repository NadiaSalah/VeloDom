...
Current repository package identity: published `1.0.1`. The package is
...
VeloDom `1.0.1` is published and verified in the npm registry. The package
...
- None for V1 `1.0.1`. Additional starter variants and future capabilities
